...
suspend fun MainClanDialog.createDialog(
...
fun MainClanDialog.createMainMenuButton(selfPlayer: ClanPlayer, targetPlayer: ClanPlayer) =
    actionButton {
