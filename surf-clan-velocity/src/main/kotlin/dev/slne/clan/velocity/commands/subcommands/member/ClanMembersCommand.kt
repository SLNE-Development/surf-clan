...
class ClanMembersCommand(clanService: ClanService) : CommandAPICommand("members") {
    init {
        ...
        executesPlayer(PlayerCommandExecutor { player, args ->
            ...
            val hasNextPage = chunkedMembers.getOrNull(page) != null
            val hasPreviousPage = chunkedMembers.getOrNull(page - 2) != null
    ...
    private fun renderPageSwapComponent(message: Component, currentPage: Int, shouldRender: (Int)-> Boolean): Component {
