...
public abstract class EssentialsCommand extends CommandTree {
   ...
   */
  public EssentialsCommand(@Pattern(PATTERN) String commandName, @NotNull String usage,
      String description, String... aliases) {
    super(commandName);
    withAliases(aliases);
    withUsage((usage.startsWith("/") ? "" : "/") + usage);
    withHelp(
        description.substring(0, Math.min(description.length(), 50)) + (description.length() > 50
            ? "..." : ""), description);
    COMMANDS.add(this);
   ...
   * {@link java.util.Collection<org.bukkit.entity.Player>}{@code <}{@link
   ...
   * <br>
   * When the argument is parsed, it returns a
   * {@link java.util.Collection<org.bukkit.entity.Entity>}{@code <}{@link
   * org.bukkit.entity.Entity}{@code >}.
   *
   * @param nodeName the name of the argument
   ...
   * <br>
   * When the argument is parsed, it returns a
   * {@link dev.slne.surf.essentials.commands.general.other.poll.Poll} object.
   *
   * @param nodeName the name of the argument
   ...
   * <br>
   * When the argument is parsed, it returns a {@link Integer} object, which represents the amount
   * of ticks.
   *
   * @param nodeName the name of the argument
   ...
   * <br>
   * When the argument is parsed, it returns a
   * {@link java.util.function.Predicate<org.bukkit.inventory.ItemStack>}{@code <}{@link
   * org.bukkit.inventory.ItemStack}{@code >} object.
   *
   * @param nodeName the name of the argument
   ...
   * <br>
   * When the argument is parsed, it returns a {@link dev.jorel.commandapi.wrappers.Location2D}
   * object.
   *
   * @param nodeName the name of the argument
   ...
   * <br>
   * When the argument is parsed, it returns a
   * {@link java.util.function.Predicate<org.bukkit.block.Block>}{@code <}{@link
   * org.bukkit.block.Block}{@code >} object.
   *
   * @param nodeName the name of the argument
   ...
   * <br>
   * When the argument is parsed, it returns a
   * {@link dev.jorel.commandapi.wrappers.FunctionWrapper}{@literal  []} array.
   *
   * @param nodeName the name of the argument
   ...
   * <br>
   * When the argument is parsed, it returns a
   * {@link dev.jorel.commandapi.wrappers.ParticleData}{@code <?>} object.
   *
   * @param nodeName the name of the argument
   ...
   * <br>
   * When the argument is parsed, it returns a {@link dev.jorel.commandapi.wrappers.Rotation}
   * object.
   *
   * @param nodeName the name of the argument
  ...
  /**
   * Gets the {@link Player} from the {@link NativeProxyCommandSender} or throws a
   * {@link WrapperCommandSyntaxException}
   *
   * @param sender the sender to get the player from
   * @return the player
   * @throws WrapperCommandSyntaxException if the sender is not a player
   */
  protected Player getPlayerOrException(NativeProxyCommandSender sender)
  ...
  /**
   * Gets the {@link Entity} from the {@link NativeProxyCommandSender} or throws a
   * {@link WrapperCommandSyntaxException}
   *
   ...
   */
  protected Entity getEntityOrException(NativeProxyCommandSender sender)
      throws WrapperCommandSyntaxException {
  ...
  /**
   * Gets any entity from the {@link NativeProxyCommandSender} or throws a
   * {@link WrapperCommandSyntaxException}
   *
   * @param sender the sender to get the entity from
   ...
   * @throws WrapperCommandSyntaxException if the sender is not an entity
   */
  protected <E extends Entity> E getSpecialEntityOrException(NativeProxyCommandSender sender,
      Class<E> type) throws WrapperCommandSyntaxException {
